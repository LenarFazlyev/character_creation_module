"""Данная функция представляет из себя графическую игру первого уровня.
Игра все еще находится в разрабтке 2023-01-12.
"""
...
def special(char_name: str, char_class: str) -> str:
    """Описывает применение специальных умений."""
    if char_class == 'warrior':
